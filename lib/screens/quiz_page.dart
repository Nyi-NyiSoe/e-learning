                                              ...
                                              TextButton(
                                                  onPressed: () {
                                                    ...
                                                    Navigator.push(context,
                                                        MaterialPageRoute(
                                                            builder: ((context) {
                                                      return QuizQuestion(categoryName: quizName,quizName: data.keys.elementAt(index));
                                                    })));
                                                  },
                              ...
                              child: Padding(
                                ...
                                child: Card(
                                  child: ListTile(
                                    ...
                                    trailing: Row(
                                      children: [
                                        Expanded(child: Text('${data[data.keys.elementAt(index)].length} Questions')),
                                        Expanded(child: Icon(Icons.diamond_outlined))
                                      ],
                                    ),
                                  ),
                                ),
